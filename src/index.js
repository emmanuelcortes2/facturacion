...
const Basic = () => (
    ...
    <div className='headline'><img src="./public/niku-logo.svg" alt="Niku Logo"></img> <h1 className='title'>Facturación</h1>
        ...
        <div className='form-container'>
            ...
            >
                ...
                <Form>
                    ...
                    <TextField id="idOperacion" name="idOperacion" label="Email" />
                    ...
                    <label className='terminos'>
                        <Field className="check-term" type="checkbox" name="terms" value="terms" />
        ...
        <Field
          ...
          type="email"
        /> } */}
                    <button className='submit-btn' type="submit">Generar Factura</button>
                </Form>
            </Formik>
        </div>
    </div>
